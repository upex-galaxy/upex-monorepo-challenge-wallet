...
import { Transaction, TransactionRequestStatus, DefaultPrivacyLevel, TransactionStatus, TransactionResponseItem } from '../../models';
...
describe('Transaction Utils', () => {
	describe('isRequestTransaction', () => {
		...
		test('validates that a transaction is a request', () => {
			for (const s in TransactionRequestStatus) {
